    ...
    <div className="min-h-screen mt-2 text-sm">
      <div className="container space-y-4">
        <div>
          ...
          <p className="text-sm">
            Here you can view your usage statistics and analytics.
          </p>
        </div>
        {/* Header */}
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Distribution of storage usage by file type
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Distribution of projects by framework
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Most common browsers accessing your projects
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
          ...
          <CardContent>
            <Tabs defaultValue="cpu">
              ...
              <TabsContent value="bandwidth" className="space-y-4">
                <h4 className="text-sm font-semibold mt-4">
                  Top Bandwidth Consuming Projects
                </h4>
                <div className="space-y-2">
                  {[
                    "Project M",
